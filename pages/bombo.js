    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <div className={styles.roomBadge} onClick={copyLink} title="Copiar enlace">
          ...
          <span className={styles.copyHint}>{copied ? "¡Copiado!" : "copiar enlace"}</span>
        </div>
      ...
      {playerHasBingo && (
        <div className={`${styles.playerAlert} ${styles.playerAlertBingo}`}>
          🏆 ¡Un jugador ha conseguido BINGO! Compruébalo y cántalo.
        </div>
      )}
      {playerHasLine && !playerHasBingo && (
        <div className={styles.playerAlert}>
          🎉 ¡Un jugador tiene LÍNEA detectada! Compruébalo y cántalo si es correcto.
        </div>
      )}

      <div className={styles.shareSection}>
        <p className={styles.shareLabel}>Invita a los jugadores a esta partida</p>
